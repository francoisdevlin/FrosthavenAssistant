...
**YOU ARE IN: `xhaven/polecats/shiny/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/xhaven/` (rig root) or other directories
...
**Your mail address:** `xhaven/polecats/shiny`
**Your rig:** xhaven
**Your Witness:** `xhaven/witness`
...
| Ask Witness for help | `gt mail send xhaven/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`xhaven/witness`) when:
...
```bash
gt mail send xhaven/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
