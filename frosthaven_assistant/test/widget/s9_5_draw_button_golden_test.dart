...
// Manual §9.5 figure: DrawButton mid-lockout (synchronizing pause).
//
...
//
// Regenerate:  flutter test --update-goldens test/widget/s9_5_draw_button_golden_test.dart
// Verify:      flutter test test/widget/s9_5_draw_button_golden_test.dart
...
void main() {
  ...
  testWidgets('s9-5 draw button sync lockout', (WidgetTester tester) async {
    ...
    await expectLater(
      ...
      matchesGoldenFile('$_goldenDir/s9-5-draw-button-lockout.png'),
    );
